...
export const loadCustomer = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get('http://54.215.250.62:3002/customer/auth');
    // const res2 = await axios.get('http://54.215.250.62:3002/restaurant/signIn');
...
export const login = (Cust_email_id, Cust_Password) => async (dispatch) => {
  ...
  try {
    const res = await axios.post(
      'http://54.215.250.62:3002/customer/auth',
      body,
      config
    );
...
export const loadRestaurantUser = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get('http://54.215.250.62:3002/restaurant/signIn');
...
export const signupRestaurantUser = ({
  ...
  try {
    const res = await axios.post(
      'http://54.215.250.62:3002/restaurant/signUP',
      body,
      config
    );
...
export const loginRestaurantUser = (Rest_email_id, Rest_Password) => async (
  ...
  try {
    const res = await axios.post(
      'http://54.215.250.62:3002/restaurant/signIn',
      body,
      config
    );
    console.log('Printing payload', res.data);
...
//     // }
//     try {
//         const res = await axios.get('http://54.215.250.62:3002/events');
