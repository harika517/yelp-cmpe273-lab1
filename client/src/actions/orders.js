...
export const createOrder = (formData, history, edit = false) => async (
  ...
  try {
    ...
    const res = await axios.post(
      `http://54.215.250.62:3002/customer/orders/me/`,
      formData,
      config
    );
    dispatch({
...
export const updateOrdersByOrderId = (
  ...
  try {
    ...
    const res = await axios.post(
      `http://54.215.250.62:3002/restaurant/orders/update/${order_id}`,
      formData,
      config
    );
...
export const getOrdersByOrderId = (order_id) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/restaurant/orders/orderdetail/${order_id}`
    );
    dispatch({
      type: GET_ORDER,
      payload: res.data,
...
export const getOrdersByStatus = (order_status) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/restaurant/orders/${order_status}`
    );
    dispatch({
      type: GET_ORDERS,
      payload: res.data,
...
export const getOrdersByCustName = (Cust_Name) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/customer/orders/ordersplaced/${Cust_Name}`
    );
    dispatch({
      type: GET_ORDERS,
      payload: res.data,
...
export const getCustOrderByStatus = (Cust_Name, Mode_Of_Delivery) => async (
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/customer/orders/ordersplaced/${Cust_Name}/${Mode_Of_Delivery}`
    );
    dispatch({
      type: GET_ORDERS,
      payload: res.data,
