...
export const getRestaurantsByDelivery = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/search/delivery/Curbside_PickUp`
    );
...
export const getRestaurantsByDineIn = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/search/delivery/Dine_In`
    );
    console.log(res.data);
    dispatch({
      type: SEARCH_RESULT,
...
export const getRestaurantsByYelpDelivery = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/search/delivery/Yelp_Delivery`
    );
    console.log(res.data);
    dispatch({
      type: SEARCH_RESULT,
...
export const getRestaurantsByInputText = (input_text) => async (dispatch) => {
  ...
  try {
    const res = await axios.get(
      `http://54.215.250.62:3002/searchresult/restaurants/${input_text}`
    );
    console.log(res.data);
    dispatch({
      type: SEARCH_RESULT,
