...
const Dashboard = ({
  ...
  //   profile.Cust_ProfilePic = `http://54.215.250.62:3002/customer/addphoto/${profile.Cust_ProfilePic}`;
  // }
  ...
  let backendimageserver = `http://54.215.250.62:3002/customer/getphoto/user/`;
    ...
    <Fragment>
      <div className="container_3columns">
        ...
        <div className="column_2">
          ...
          <p className="lead">
            <i className="fas fa-home"> </i> {profile.City} {profile.State}{' '}
            {profile.Country}{' '}
          </p>{' '}
          <hr />
        ...
        <div className="column_3">
          <DashboardActions />
          <hr />
          <p className="bold text-dark medium">
            {' '}
            About {profile.Cust_Name}...{' '}
          </p>{' '}
